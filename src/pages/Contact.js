                ...
                <div className="container">
                  <div className="row">
                    <div className="col-lg-2">
                      <div className="card">
                      <FontAwesomeIcon className="icons me-1" icon={faFacebook} />
                      </div>
                    </div>
                  </div>
              </div>
    ...
    <div class="container">
        <div class="row al">
            <div class="col-md-3 col-sm-6 text-lg-start text-center">
                ...
                <p>Purok Malipayon , Brgy. Tagukon, Kabankalan City <br/> Negros Occidental, Philippines</p>
            </div>
            <div class="col-md-3 col-sm-6 text-lg-start text-center">
            <h5 className="fw-bold">
